...
from vanttec_uuv.msg import orbitAction
from nav_v1 import uuv_instance
import math

class orbitServer:
    def __init__(self):
        self.server = actionlib.SimpleActionServer('orbit', orbitAction, self.execute, False)
        self.server.start()
        self.isrot = False
        self.ismov = False
        self.ned_x = None
        ...
        rospy.loginfo("orbit server loaded OK")
