...
from vanttec_uuv.srv import color_id
from cv_bridge import CvBridge, CvBridgeError
from sensor_msgs.msg import Image
from sensor_msgs.msg import PointCloud2

from vanttec_uuv.msg import obj_detected
from vanttec_uuv.msg import obj_detected_list
...
class Detection_Node:
    def __init__(self):
        ...
        rospy.Subscriber("/frontr200/camera/depth/image_raw", Image, self.callback_depth_img)
    ...
    def callback_zed_img(self,img):
        ...
        self.image = cv2.flip(self.image, -1) # Just for temporal solution for simulations

    def callback_depth_img(self,img):
        """ ZED rect_image callback"""
        self.depth = self.bridge.imgmsg_to_cv2(img, img.encoding)
        self.depth = cv2.flip(self.depth, -1) # Just for temporal solution for simulations
    ...
    def detect(self):
        ...
        while not rospy.is_shutdown():
            # Grab next frame
            #rospy.loginfo("IM searching for stuf")
            ...
            for ix in indices:
                ...
                if detect == True:
                    ...
                    obj.Depth = float(self.depth[pix[1], pix[0]])
                    # obj.id = -1
                    obj.color = " "
